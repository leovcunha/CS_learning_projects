...
def find_closest(location, centroids):
    ...
    for i in centroids:
        ...
        if distances[k] < distclose:
            closest=i
            distclose=distances[k]
        k+=1
    return closest    
    # END Question 3
...
def find_centroid(cluster):
    ...
    # BEGIN Question 5
    i = [restaurant_location(res) for res in cluster]
    return [mean([x for x, _ in i]), mean([y for _, y in i])]
    # END Question 5
...
def k_means(restaurants, k, max_updates=100):
    ...
    while old_centroids != centroids and n < max_updates:
        ...
        # BEGIN Question 6
        lclusters = group_by_centroid(restaurants, centroids)
        centroids = [find_centroid(cluster) for cluster in lclusters] 
        # END Question 6
        n += 1
    return centroids
