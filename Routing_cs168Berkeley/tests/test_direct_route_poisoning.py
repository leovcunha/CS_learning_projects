"""
Tests that the router performs direct route poisoning.
...
through. Then disconnects s3 and h2. Then, after letting the routers exchange
...
def launch():
    ...
    def test_tasklet():
        ...
        api.userlog.debug('Disconnecting s3 and h2')
        s3.unlinkTo(h2)
